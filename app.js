...
const resetGame = () => {
    ...
    pScore.innerHTML = '0';
    cScore.innerHTML = '0';
    showIcon.className = rockIcon;        // Set to the closed hand for the player
    computerShowIcon.className = scissorsIcon; // Set to the pointing hand for the computer
    text.innerHTML = 'Try your luck!';
    text2.innerHTML = 'Try your luck!';
}
